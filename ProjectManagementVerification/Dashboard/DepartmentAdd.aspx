<%@ Page Title="" Language="C#" MasterPageFile="~/ViewMaster/DashBoard.Master" AutoEventWireup="true" CodeBehind="DepartmentAdd.aspx.cs" Inherits="ProjectManagementVerification.Dashboard.DepartmentAdd" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <div id="content" class="span10">
					...
					<div class="box-content">
							...
							<table>
							    ...
							    <tr>
                                    ...
                                    <td><asp:TextBox  ID="txtDepartmentName" CssClass="form-control" placeholder="Enter Department Name" runat="server"></asp:TextBox></td>
                                    <td>
            ...
            ErrorMessage="Enter a Valid Name" ValidationExpression="^[a-zA-Z'.\s]{1,50}" ValidationGroup="ReqGroup"></asp:RegularExpressionValidator>
                                    </td>
							    </tr>
                            ...
                            <div class="search_section">
                            <asp:GridView ID="GridView1" PageSize="6" AllowPaging="true"  
                                AutoGenerateColumns="false" PagerStyle-CssClass="paging"
                                    class="table table-hover table-bordered" DataKeyNames="Id" runat="server" OnPageIndexChanging="GridView1_PageIndexChanging" OnRowEditing="GridView1_RowEditing" OnRowDeleting="GridView1_RowDeleting" >
                                    <Columns>
